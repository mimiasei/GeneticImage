...
public class UnsortedList<T> extends SortedList<T> {
	...
	private class UnsortedNode extends Node {
		...
		/**
		 * Gets the index of this node in the list, using the cached dblValue if it is not
		 * stale and otherwise calculating it from the ancestor nodes and setting the cached dblValue.
		 */
