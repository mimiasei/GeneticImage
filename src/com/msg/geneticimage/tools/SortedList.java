...
public class SortedList<T> extends AbstractList<T> implements Serializable {
    ...
    public boolean add(T object){
        ...
        if(object != null){
            //wrap the dblValue in a node and add it..
    ...
    //Returns the node representing the given dblValue in the tree, which can be null if
    //no such node exists..
    ...
    /**
     * Removes the first element in the list with the given dblValue, if such
     ...
     *
     * @param dblValue the object to remove from this {@code SortedList}.
   ...
   public Object[] toArray(){
       ...
       if(root != null){
           Node next = root.smallestNodeInSubTree(); //start with the smallest dblValue.
           while(next != null){
    ...
    *
    * @param T the dblValue the node will store.
    */
   protected class Node implements Comparable<Node > {
    
	   private T value; //the data dblValue being stored at this node 
        ...
        * the newer the node the higher this dblValue.
        */
       protected final int id;
       
       /**
        * Constructs a new Node which initially just stores the given dblValue.
        *
        * @param t the dblValue which this node will store.
        */
       protected Node(T t){
           this.value = t;
       ...
       /**
        * Compares the dblValue stored at this node with the dblValue at the given node using
       ...
       public String toString(){
           ...
           sb.append("[Node: dblValue: " + value);
           sb.append(", leftChild dblValue: " + ((leftChild == null) ? "null" : leftChild.value));
           sb.append(", rightChild dblValue: " + ((rightChild == null) ? "null" : rightChild.value));
       ...
       /**
        * Returns the dblValue stored at this {@code Node}.
        * 
        * @return the dblValue that this {@code Node} stores.
        */
       public T getValue(){
    	   return value;
       }
       ...
       private void rightRotateAsPivot(){
        ...
        //should only be called when this is doing to be removed and has just one dblValue..
