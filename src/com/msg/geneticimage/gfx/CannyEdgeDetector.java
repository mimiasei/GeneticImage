...
//				float gradMag = hypot(xGrad, yGrad);
				float gradMag = Math.abs(xGrad) + Math.abs(yGrad);
...
//				float nwMag = hypot(xGradient[indexNW], yGradient[indexNW]);
				float nMag = Math.abs(xGradient[indexN]) + Math.abs(yGradient[indexN]);
				float sMag = Math.abs(xGradient[indexS]) + Math.abs(yGradient[indexS]);
				float wMag = Math.abs(xGradient[indexW]) + Math.abs(yGradient[indexW]);
				float eMag = Math.abs(xGradient[indexE]) + Math.abs(yGradient[indexE]);
				float neMag = Math.abs(xGradient[indexNE]) + Math.abs(yGradient[indexNE]);
				float seMag = Math.abs(xGradient[indexSE]) + Math.abs(yGradient[indexSE]);
				float swMag = Math.abs(xGradient[indexSW]) + Math.abs(yGradient[indexSW]);
				float nwMag = Math.abs(xGradient[indexNW]) + Math.abs(yGradient[indexNW]);
				float tmp;
				/*
	...
	// Me: Yup, I did that. Replaced hypot(x, y) with Math.abs(x) + Math.abs(y)
